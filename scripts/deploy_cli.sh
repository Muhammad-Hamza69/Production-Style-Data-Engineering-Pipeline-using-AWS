...
cat <<EOF > /tmp/sfn_def.json
{
  ...
  "States": {
    "IngestFromYouTubeAPI": {
      ...
      "Parameters": {
        "FunctionName": "arn:aws:lambda:${AWS_REGION}:${ACCOUNT_ID}:function:yt-ingest",
        "Payload": {
    ...
    "RunRawTransform": {
      ...
      "Resource": "arn:aws:states:::lambda:invoke",
      "Parameters": {
        "FunctionName": "arn:aws:lambda:${AWS_REGION}:${ACCOUNT_ID}:function:yt-raw-transform",
        "Payload": {
          "triggered_by": "step_functions",
          "execution_id.$": "$$.Execution.Id"
        }
    ...
    "RunDbtBuild": {
      ...
      "Resource": "arn:aws:states:::lambda:invoke",
      "Parameters": {
        "FunctionName": "arn:aws:lambda:${AWS_REGION}:${ACCOUNT_ID}:function:yt-dbt-trigger",
        "Payload": {
          "triggered_by": "step_functions",
          "execution_id.$": "$$.Execution.Id"
        }
